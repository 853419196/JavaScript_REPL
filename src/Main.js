            ...
            switch(Object.prototype.toString.call(output))
            {
                ...
                case "[object Error]":
                {
                    ...
                    else
                    {
                        ...
                        print(out);
                        if(stackString)print(stackString);
                    }
                    break;
                }
                case "[object Null]":
                ...
                case "[object String]":
                {
                    ...
                    else
                    {
                        ...
                        if(throwBoolean)print("Uncaught:");
                        print(out);
                    }
                    break;
                }
...
do
{
    ...
    if(repl.__editorBoolean__)
    {
        if(repl.__inputString__)repl.__evalString__+=repl.__inputString__+"\n";
        else
        {
            repl.__editorBoolean__=false;
            __evalFunction__(repl.__evalString__);
        }
    }
    else
    {
        repl.__evalString__=repl.__inputString__;
        __evalFunction__(repl.__evalString__);
    }
